      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl">
            At TypeSprint, we are committed to protecting your privacy. Learn
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: <FaUserShield className="h-8 w-8 text-cyan-400" />,
                ...
                description: (
                  <>
                    ...
                    <ul className="list-disc list-inside text-gray-400 space-y-2">
                      ...
                      <li>
                        <strong>Usage Data:</strong> Typing speed, accuracy, and
                        test performance.
                      </li>
                      <li>
              ...
              },
              {
                ...
                description: (
                  <>
                    <p className="text-gray-300 mb-4">
                      Your information helps us enhance your experience and
                      provide personalized services:
                    </p>
                    <ul className="list-disc list-inside text-gray-400 space-y-2">
                      <li>Improving user experience with AI-based insights.</li>
                      <li>Communicating updates, new features, and support.</li>
                      <li>
                        Analyzing performance for tailored learning
                        recommendations.
                      </li>
                    </ul>
                  </>
              ...
              {
                icon: <FaLock className="h-8 w-8 text-cyan-400" />,
                title: "Data Security",
                description: (
                  <p className="text-gray-400">
                    We prioritize your data's safety using SSL encryption and
                    secure databases. Your personal information is never sold or
                    shared with third parties, except as required by law.
                  </p>
                ),
              },
              {
                icon: <FaCookieBite className="h-8 w-8 text-cyan-400" />,
                title: "Cookies",
                description: (
                  <p className="text-gray-400">
                    We use cookies to enhance functionality and track usage
                    patterns. You can manage cookie preferences through your
                    browser settings.
                  </p>
                ),
              },
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">
              Have questions about our Privacy Policy? Reach out to us.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="subject"
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white"
                      placeholder="Privacy Policy Inquiry"
                    />
                  </div>
                  <div>
                    <label
