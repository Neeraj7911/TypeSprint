...
import { FaBan, FaEnvelope, FaPhone } from "react-icons/fa";

const NoRefundAndShippingPolicy = () => {
        ...
        >
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
              No Refund & Shipping Policy
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl">
            As a digital SaaS product, TypeSprint has specific policies
            regarding refunds and shipping. Please review them below.
          </p>
        </div>
            ...
            {[
              {
                ...
                description: (
                  <p className="text-gray-400">
                    TypeSprint is a digital Software as a Service (SaaS)
                    product. No physical products are shipped, and therefore, no
                    shipping policies apply.
                  </p>
                ),
              },
              {
                ...
                description: (
                  <p className="text-gray-400">
                    As a digital service, TypeSprint does not offer returns or
                    exchanges. Access to our platform is provided immediately
                    upon purchase.
                  </p>
                ),
              },
              {
                ...
                description: (
                  <p className="text-gray-400">
                    All payments made to TypeSprint are final. Refunds will not
                    be issued once access to the platform is granted. Please
                    review our pricing details before purchasing.
                  </p>
                ),
              },
            ].map((section, index) => (
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">
              Have questions about our No Refund & Shipping Policy? Reach out to
              us.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="subject"
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white"
                      placeholder="Refund & Shipping Policy Inquiry"
                    />
                  </div>
                  <div>
                    <label
...
export default NoRefundAndShippingPolicy;
